...
export default function Rotate() {
  ...
  return (
    <div className="rotate">
      <div className="page-container">
        <div className="circle-container">
          <div className="circle">
            <i className="open hidden" id="open"></i>
            <i className="close" id="close"></i>
          </div>
        </div>
      ...
      <nav id="navList" className="navList">
        <ul>
          <li>
          ...
          <li>
            <a
              href="http://www.eveningwater.com/my-web-projects/"
              target="_blank"
          ...
          <li>
            <a href="http://github.com/eveningwater" target="_blank" rel="noopener noreferrer">
              github
            </a>
          </li>
        </ul>
